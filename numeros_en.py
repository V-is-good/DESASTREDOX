...
def inicio():
       ...
       try: 
         ...
         if data['valid'] == False:
           ...
           print('\n[⏈⃟𝒦⃟⚖] Numero: ', data['number'])
           print('[⏈⃟𝒦⃟⚖] Codigo del pais: ', data['country_code'])
           print('[⏈⃟𝒦⃟⚖] Nombre del pais: ', data['country_name'])
           print('[⏈⃟𝒦⃟⚖] Ubicacion: ', data['location'])
           print('[⏈⃟𝒦⃟⚖] Transportador: ', data['carrier'])
       except KeyError:
           try:
             ...
             if data1['valid'] == False:
               ...
               print('\n[⏈⃟𝒦⃟⚖] Numero: ', data1['number'])
               print('[⏈⃟𝒦⃟⚖] Codigo del pais: ', data1['country_code'])
               print('[⏈⃟𝒦⃟⚖] Nombre del pais: ', data1['country_name'])
               print('[⏈⃟𝒦⃟⚖] Ubicacion: ', data1['location'])
               print('[⏈⃟𝒦⃟⚖] Transportador: ', data1['carrier'])
           except KeyError:
              try:
                ...
                if data3['valid'] == False:
                 ...
                 print('\n[⏈⃟𝒦⃟⚖] Numero: ', data3['number'])
                 print('[⏈⃟𝒦⃟⚖] Codigo del pais: ', data3['country_code'])
                 print('[⏈⃟𝒦⃟⚖] Nombre del pais: ', data3['country_name'])
                 print('[⏈⃟𝒦⃟⚖] Ubicacion: ', data3['location'])
                 print('[⏈⃟𝒦⃟⚖] Transportador: ', data3['carrier'])
              except KeyError:
                 try:
                   ...
                   if data4['valid'] == False:
                    ...
                    print('\n[⏈⃟𝒦⃟⚖] Numero: ', data4['number'])
                    print('[⏈⃟𝒦⃟⚖] Codigo del pais: ', data4['country_code'])
                    print('[⏈⃟𝒦⃟⚖] Nombre del pais: ', data4['country_name'])
                    print('[⏈⃟𝒦⃟⚖] Ubicacion: ', data4['location'])
                    print('[⏈⃟𝒦⃟⚖] Transportador: ', data4['carrier'])
                 except KeyError:
                   try:
                     ...
                     if data5['valid'] == False:
                        ...
                        print('\n[~] Numero: ', data5['number'])
                        print('[⏈⃟𝒦⃟⚖] Codigo del pais: ', data5['country_code'])
                        print('[⏈⃟𝒦⃟⚖] Nombre del pais: ', data5['country_name'])
                        print('[⏈⃟𝒦⃟⚖] Ubicacion: ', data5['location'])
                        print('[⏈⃟𝒦⃟⚖] Transportador: ', data5['carrier'])
                   except KeyError:
                      print('\n[!] APIs agotadas debes esperar a que sean actualizadas')
                      sleep(2)
                      os.system("python3 desastre.py")